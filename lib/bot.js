...
const WELCOME_MESSAGE = process.env.BOT_WELCOME_MESSAGE || 
  'Добро пожаловать в систему обучения! Перейдите на сайт, чтобы начать обучение. У вас запросят код подтверждения. Он придет сюда, в этот чат с ботом';
...
class TelegramBot {
  ...
  async showMainMenu(ctx) {
    ...
    const webAppUrl = process.env.VERCEL_URL || process.env.WEB_APP_URL
